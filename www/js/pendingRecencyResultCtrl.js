                    ...
                    $preLoader.hide();
                     ...
                     // console.log($scope.recencyVlDatas);
                        ...
                        for(i=0;i<$scope.recencyVlDatas.length;i++){
                          if($scope.recencyVlDatas[i]['final_outcome']=='null' || $scope.recencyVlDatas[i]['final_outcome']==null ){
                            $scope.recencyVlCountData.push($scope.recencyVlDatas[i]['final_outcome']);
                          }
                        }
