  ...
  $scope.recency = {};
    ...
    $scope.displaybadge = false;
     ...
     //   console.log(device)
      ...
      $scope.optionalData = JSON.parse(localStorage.getItem('OptionalData'));
...
$scope.GetDistrictValue = function(province){
  ...
  //sss
  for(i=0;i<localDistrict.length;i++){
    
    if(localDistrict[i]['province_id'] === province){
      console.log("hi")
      return true;
